...
Pages publishes through **GitHub Actions**, with version tags allowed in the `github-pages` environment. Publishing a non-prerelease GitHub release reruns the complete verification workflow at that tag, then deploys its `dist/` artifact. This follows GitHub's [custom Pages workflow](https://docs.github.com/en/pages/getting-started-with-github-pages/using-custom-workflows-with-github-pages). The [v0.1.1 deployment](https://github.com/titusz/wet-explorer/actions/runs/35497613483) passed all 146 unit/worker and 149 browser checks before publishing, including wide-screen landing/picker regressions. See the [completion audit](docs/completion-audit.md) for deployed-file verification and live Chrome/Firefox results.
